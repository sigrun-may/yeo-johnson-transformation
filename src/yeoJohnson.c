...
/**
 * @brief (float) first formular of the Yeo Johnson transformation (y>=0,
 * lambda!= 0)
 *
 * @param y value to be transformed
 * @param lambda transformation parameter
...
/**
 * @brief (double) first formular of the Yeo Johnson transformation
 * (y>=0,lambda!= 0), without error handling
 *
 * @param y value to be transformed
 * @param lambda transformation parameter
 * @param result resulting value after transformation
...
/**
 * @brief (float) first formular of the Yeo Johnson transformation
 * (y>=0,lambda!= 0), without error handling
 *
 * @param y value to be transformed
 * @param lambda transformation parameter
...
/**
 * @brief (double) second formular of the Yeo Johnson transformation
 * (y>=0, lambda == 0), without error handling
 *
 * @param y value to be transformed
 * @param result resulting value after transformation
...
/**
 * @brief (float) second formular of the Yeo Johnson transformation
 * (y>=0, lambda == 0), without error handling
 *
 * @param y value to be transformed
 * @param result resulting value after transformation
...
/**
 * @brief (double) third formular of the Yeo Johnson transformation
 * (y<0, lambda != 2), without error handling
 *
 * @param y value to be transformed
 * @param lambda transformation parameter
 * @param result resulting value after transformation
...
/**
 * @brief (float) third formular of the Yeo Johnson transformation
 * (y<0, lambda != 2), without error handling
 *
 * @param y value to be transformed
 * @param lambda transformation parameter
...
/**
 * @brief (float) fourth formular of the Yeo Johnson transformation
 * (y<0, lambda == 2)
 *
 * @param y value to be transformed
 * @param lambda transformation parameter
...
/**
 * @brief (float) defines the boundaries of any value passed to yjCalculation
 *
 * @param lower_lambda lowest lambda possible for this search
 * @param upper_lambda highest lambda possible for this search
 */
void buildBoundaryBoxf(float lower_lambda, float upper_lambda) {
  ...
  lower_lambda = (lower_lambda == 0) ? -1 : lower_lambda;
  bBf_yj1.upper_limit =
      powf(upper_lambda * g_max_high_float + 1, 1 / upper_lambda) - 1;
  bBf_yj1.lower_limit =
      powf(lower_lambda * g_max_low_float + 1, 1 / lower_lambda) - 1;

  upper_lambda = (upper_lambda == 2) ? 3 : upper_lambda;
  lower_lambda = (lower_lambda == 2) ? 1 : lower_lambda;
  bBf_yj3.upper_limit = -(
      powf(-g_max_high_float * (2 - upper_lambda) + 1, 1 / (2 - upper_lambda)) -
      1);
  bBf_yj3.lower_limit = -(
      powf(-g_max_low_float * (2 - lower_lambda) + 1, 1 / (2 - lower_lambda)) -
      1);
  bBf_set = 1;
}
